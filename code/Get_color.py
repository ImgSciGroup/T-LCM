...
import os
# paviau colormodel
# imgpath = 'D:\Paper-07-20240114\Experiment\Compaired\PU\\'
...
# imgpath = 'D:\Paper04-20230615\Experiment2\Paviac\\'
# files = os.listdir(imgpath)
# for file in files:
#     if file.endswith('.bmp'):
#         path = imgpath+str('\\')+file
...
# #Scale32
# imgpath = 'D:\Paper06-20230825-Network\Code\Our\\'
# files = os.listdir(imgpath)
# for file in files:
...
#JX01
# imgpath = 'D:\Paper04-20230615\Experiment2\JX01\\'
# files = os.listdir(imgpath)
# for file in files:
#     if file.endswith('.bmp'):
#         path = imgpath+str('\\')+file
...
#Trento
# imgpath = 'D:\Paper04-20230615\Data\Trento\\'
# files = os.listdir(imgpath)
# for file in files:
#     if file.endswith('.bmp'):
#         path = imgpath+str('\\')+file
...
#
#
#         cv2.imwrite(imgpath+str('Trento_color{}'.format(file)), resultimg)


#GF-02
# imgpath = 'D:\Paper04-20230615\Experiment2\GF-SUB\\'
# files = os.listdir(imgpath)
# for file in files:
#     if file.endswith('.bmp'):
#         path = imgpath+str('\\')+file
...
#
#         cv2.imwrite(imgpath+str('GF-sub_color{}'.format(file)), resultimg)


#Houston2013 colormodel
# imgpath = 'D:\Paper06-20230825-Network\Code\Code\HC_ADGAN-master\\'
# files = os.listdir(imgpath)
# for file in files:
#     if file.endswith('.png'):
#         path = imgpath+str('\\')+file
...
#             for j in range(gt_img.shape[1]):
#                 if gt_img[i][j][0] == 1:
#                     resultimg[i][j] = (53, 206, 50)
#                 if gt_img[i][j][0] == 2:
#                     resultimg[i][j] = (3, 254, 2)
#                 if gt_img[i][j][0] == 3:
#                     resultimg[i][j] = (136, 139, 34)
#                 if gt_img[i][j][0] == 4:
#                     resultimg[i][j] = (7, 128, 5)
#                 if gt_img[i][j][0] == 5:
#                     resultimg[i][j] = (49, 85, 156)
#                 if gt_img[i][j][0] == 6:
#                     resultimg[i][j] = (138, 1, 3)
#                 if gt_img[i][j][0] == 7:
#                     resultimg[i][j] = (255, 0, 255)
#                 if gt_img[i][j][0] == 8:
#                     resultimg[i][j] = (0, 255, 255)
#                 if gt_img[i][j][0] == 9:
#                     resultimg[i][j] = (127, 127, 127)
#                 if gt_img[i][j][0] == 10:
#                     resultimg[i][j] = (8, 5, 130)
#                 if gt_img[i][j][0] == 11:
#                     resultimg[i][j] = (147, 17, 249)
#                 if gt_img[i][j][0] == 12:
#                     resultimg[i][j] = (130, 128, 240)
#                 if gt_img[i][j][0] == 13:
#                     resultimg[i][j] = (40, 120, 210)
#                 if gt_img[i][j][0] == 14:
#                     resultimg[i][j] = (245, 15, 250)
#                 if gt_img[i][j][0] == 15:
#                     resultimg[i][j] = (250, 250, 5)
#         cv2.imwrite(imgpath+str('Houston_color{}'.format(file)), resultimg)
...
#                     resultimg[i][j] = (255, 255, 255)
#                 if gt_img[i][j][0] == 1:
#                     resultimg[i][j] = (0, 206, 0)
#                 if gt_img[i][j][0] == 2:
#                     resultimg[i][j] = (0, 254, 127)
#                 if gt_img[i][j][0] == 3:
#                     resultimg[i][j] = (87, 139, 46)
#                 if gt_img[i][j][0] == 4:
#                     resultimg[i][j] = (0, 139, 0)
#                 if gt_img[i][j][0] == 5:
#                     resultimg[i][j] = (45, 82, 160)
#                 if gt_img[i][j][0] == 6:
#                     resultimg[i][j] = (255, 255, 0)
#                 if gt_img[i][j][0] == 7:
#                     resultimg[i][j] = (255, 255, 255)
#                 if gt_img[i][j][0] == 8:
#                     resultimg[i][j] = (216, 191, 216)
#                 if gt_img[i][j][0] == 9:
#                     resultimg[i][j] = (100, 100, 255)
#                 if gt_img[i][j][0] == 10:
#                     resultimg[i][j] = (0, 0, 139)
#                 if gt_img[i][j][0] == 11:
#                     resultimg[i][j] = (255, 0, 0)
#                 if gt_img[i][j][0] == 12:
#                     resultimg[i][j] = (0, 255, 255)
...
#                 if gt_img[i][j][0] == 14:
#                     resultimg[i][j] = (139, 26, 85)
#                 if gt_img[i][j][0] == 15:
#                     resultimg[i][j] = (80, 127, 255)
#                 if gt_img[i][j][0] == 15:
#                     resultimg[i][j] = (255, 255, 255)
#         cv2.imwrite(imgpath+str('Houston_color{}'.format(file)), resultimg)
...
#
# gt_img = cv2.imread("D:\Paper06-20230825-Network\\2D-CNN.bmp")
# resultimg = np.zeros(gt_img.shape, np.uint8)
# for i in range(gt_img.shape[0]):
#     for j in range(gt_img.shape[1]):
#         if gt_img[i][j][0] == 1:
...
#             resultimg[i][j] = (254, 0, 255)
#
# cv2.imwrite("D:\Paper06-20230825-Network\\2D-CNN.png", resultimg)
...
# salinscolormodel
# gt_img = cv2.imread("D:\Paper08-20240515-RSE\Code\\Res_6.bmp")
# resultimg = np.zeros(gt_img.shape, np.uint8)
# for i in range(gt_img.shape[0]):
#     for j in range(gt_img.shape[1]):
#         if gt_img[i][j][0] == 1:
...
#
#
# cv2.imwrite("D:\Paper08-20240515-RSE\Code\\result_color1.png", resultimg)
import tifffile
imgpath = 'D:\Paper08-20240515-RSE\Data\WuHan\Intermediate results\Compared_Augmentation\ADGAN\\'
img = tifffile.imread('D:\Paper08-20240515-RSE\Data\WuHan\\201812.tif')
        ...
        for i in range(img.shape[0]):
            for j in range(img.shape[1]):
                if np.all(img[i,j]==0):
                    ...
                    if gt_img[i][j][0] == 1:
                        resultimg[i][j] = (255, 184, 88)
                    if gt_img[i][j][0] == 2:
                        resultimg[i][j] = (31,70,25)
                    if gt_img[i][j][0] == 3:
                        resultimg[i][j] = (27, 208, 138)
                    if gt_img[i][j][0] == 4:
                        resultimg[i][j] = (128, 168, 222)
                    if gt_img[i][j][0] == 5:
                        resultimg[i][j] = (56, 67, 212)
                    if gt_img[i][j][0] == 6:
                        resultimg[i][j] = (156, 214, 255)
                    if gt_img[i][j][0] == 7:
                        resultimg[i][j] = (173, 222, 255)

        cv2.imwrite(imgpath + str('ADGAN_color{}'.format(file)), resultimg)